...
const DashboardCard = ({ children, title, className }: Props) => {
  ...
  return (
    <section
      className={clsx(
        "h-full w-full grid overflow-hidden rounded-2xl sm:rounded-3xl backdrop-blur-lg px-4 sm:px-6 md:px-8 py-6 sm:py-8 md:py-10 font-leaguespartan text-light-blue",
